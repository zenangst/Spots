...
public protocol RefreshDelegate: class {
  ...
  ///
  /// - parameter spots: A collection of CoreComponent objects
  ...
  #if os(iOS)
  func spotablesDidReload(_ spots: [CoreComponent], refreshControl: UIRefreshControl, completion: Completion)
  #endif
}
