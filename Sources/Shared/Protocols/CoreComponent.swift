...
//
//  /// The index of a Component object
//  var index: Int { get }
//  /// A computed value for the size of the Component object
//  var computedHeight: CGFloat { get }
//  /// The component of a Component object
...
//  /// A cache for a Component object
...
//  /// Return a Component object as a UIScrollView
//  var view: ScrollView { get }
//
//  #if os(OSX)
//    /// The current responder for the Component object, only available on macOS.
//    var responder: NSResponder { get }
//    /// The next responder for the Component object, only available on macOS.
//    var nextResponder: NSResponder? { get set }
//  #endif
//
//  /// Initialize a Component object with a ComponentModel.
//  ///
...
//
//  /// Perform internal preperations for a Component object
//  func register()
//
